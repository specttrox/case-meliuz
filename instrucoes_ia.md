...
1. **Receba o Arquivo:** O usuário indicará o nome de um arquivo CSV localizado na pasta `dados/` (ex: `dados/dataset_01_parceiroA.csv`).
2. **Execute o Analisador:** No terminal, execute o script base utilizando o Python:
   `python analisador_ab.py <caminho_do_arquivo>`
